...
![भेजने-पाने का प्रवाह: sendHandshake → mb- मेलबॉक्स → readMailbox, और encryptRoomMessage → p- कमरा → subscribe से डिक्रिप्ट। सर्वर को सिर्फ़ एन्क्रिप्टेड टेक्स्ट ही दिखता है](../images/hi/flow.png)
...
![Ed25519 यानी हस्ताक्षर (निजी चाबी से sign → सार्वजनिक चाबी से verify), X25519 यानी चाबी साझा करना (दो लोग एक ही गुप्त S को बिना भेजे बना लेते हैं → HKDF → AES चाबी)](../images/hi/keys.png)
